  ...
  async.parallel(
    {
      book_count: function (callback) {
        Book.countDocuments({}, callback); //Passing empty object as match condition to find all documents of this collection
      },
      book_instance_count: function (callback) {
        Bookinstance.countDocuments({}, callback);
      },
      book_instance_available_count: function (callback) {
        Author.countDocuments({ status: "Available" }, callback);
      },
...
exports.book_delete_post = function (req, res, next) {
  // Assume the post has a valid id
  ...
  async.parallel(
    ...
    function (err, results) {
      ...
      if (results.book_bookinstances.length > 0) {
        // Book har instances. render in same way as for GET routes
        res.render("book_delete", {
          title: "Delete Book",
          book: results.book,
          book_instances: results.book_bookinstances,
        ...
        // Book has no BookInstances objects. Delete object and redirect to the list of books
